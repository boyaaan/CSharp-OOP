...
namespace StorageMaster.Controller
{
    ...
    public class StorageMaster
    {
        ...
        private readonly VahicleFactoty vehicleFactory;
        ...
        public StorageMaster()
        {
            ...
            this.vehicleFactory = new VahicleFactoty();
        }
        ...
        public string AddProduct(string type, double price)
        {
            ...
            var product = this.productFactory.CreatProduct(type, price);
        ...
        public string LoadVehicle(IEnumerable<string> productNames)
        {
            ...
            foreach (var name in productNames)
            {
                ...
                this.currVehicle.LoadProduct(product);
            ...
            return $"Loaded {loadedProductsCount}/{totalProductsCount} products into {this.currVehicle.GetType().Name}";
        }
